...
const SignupScreen = ({ navigation }) =>{
    return(
      ...
      <View style={styles.boxcontainer}>
        <Text style={{alignSelf:'flex-start',top:'10%',position:'absolute'}}>Sign up to your account</Text>
      ...
      <Text style={{textAlign:'left',fontSize:20,alignSelf:'flex-start',marginBottom:10,}}>Passcode</Text>
      <TextInput placeholder="****" style={styles.Textinput1}></TextInput>
      <TouchableOpacity onPress={() => navigation.navigate('MainScreen')}><View style={styles.box}>
        <Text style={{color:'white',fontSize:20,}}>Sign Up</Text>
      </View></TouchableOpacity>
      <Text style={{fontSize:15,marginBottom:30,}}>Forget Password?</Text>
      <Text style={{fontSize:15,marginBottom:10,}}>Don't have an account?<Text style={{color:'blue'}}>create now</Text></Text>
...
const Signup = () => {
  return (
    ...
    <HomeStack.Navigator>
        ...
        <HomeStack.Screen name="MainScreen" component={Main} options={{ headerShown: false }} />
